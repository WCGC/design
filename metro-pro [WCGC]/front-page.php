...
function metro_home_genesis_meta() {
	...
	if ( is_active_sidebar( 'home-top' ) || is_active_sidebar( 'home-middle-left' ) || is_active_sidebar( 'home-middle-right' ) || is_active_sidebar( 'home-bottom' ) || is_active_sidebar( 'prueba' )) {
...
function metro_homepage_widgets() {
	...
	genesis_widget_area( 'prueba', array(
		'before' => '<div class="prueba widget-area">',
		'after'  => '</div>',
	) );
